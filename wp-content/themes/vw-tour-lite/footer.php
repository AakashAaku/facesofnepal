    ...
    <div class="copyright-wrapper">
    	<div class="container">
            <div class="copyright">
                ...
                <?php if( get_theme_mod( 'vw_tour_lite_hide_show_scroll',true) != '') { ?>
                    <?php $theme_lay = get_theme_mod( 'vw_tour_lite_scroll_top_alignment','Right');
                    if($theme_lay == 'Left'){ ?>
                        <a href="#" class="scrollup left"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-tour-lite' ); ?></span></a>
                    <?php }else if($theme_lay == 'Center'){ ?>
                        <a href="#" class="scrollup center"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-tour-lite' ); ?></span></a>
                    <?php }else{ ?>
                        <a href="#" class="scrollup"><i class="fas fa-angle-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-tour-lite' ); ?></span></a>
                    <?php }?>
                <?php }?>
            </div>
        </div>
