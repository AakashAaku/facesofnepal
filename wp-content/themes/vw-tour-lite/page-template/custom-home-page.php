...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod('vw_tour_lite_slider_hide_show',true) != ''){ ?>
    <section id="slider">
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <div class="more-btn">              
                    <a href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','vw-tour-lite'); ?><i class="fas fa-angle-right"></i><span class="screen-reader-text"><?php esc_html_e( 'Read More','vw-tour-lite' );?></span></a>
                  </div>
                </div>
              </div>
            </div>
