...
function vw_tour_lite_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Shop Page Sidebar', 'vw-tour-lite' ),
		'description'   => __( 'Appears on shop page', 'vw-tour-lite' ),
	...
	register_sidebar( array(
		'name'          => __( 'Single Product Sidebar', 'vw-tour-lite' ),
		'description'   => __( 'Appears on shop page', 'vw-tour-lite' ),
...
define('VW_TOUR_LITE_BUY_NOW','https://www.vwthemes.com/themes/vw-tour-theme/','vw-tour-lite');
...
define('VW_TOUR_LITE_CREDIT','https://www.vwthemes.com/themes/free-vw-tour-theme/','vw-tour-lite');

if ( ! function_exists( 'vw_tour_lite_credit' ) ) {
	function vw_tour_lite_credit(){
		echo "<a href=".esc_url(VW_TOUR_LITE_CREDIT).">". esc_html__('Tour WordPress Theme','vw-tour-lite')."</a>";
	}
}
