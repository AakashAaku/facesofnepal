...
<body <?php body_class(); ?>>
  ...
  <header role="banner">
    ...
    <div id="header">
      <?php if( get_theme_mod('vw_tour_lite_topbar_hide_show',true) != ''){ ?>
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-4">
              <div class="toggle-nav mobile-menu">
                <button onclick="menu_openNav()"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-tour-lite'); ?></span></button>
              </div>
              <div id="mySidenav" class="nav sidenav">
                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'vw-tour-lite' ); ?>">
                  <a href="javascript:void(0)" class="closebtn mobile-menu" onclick="menu_closeNav()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Button','vw-tour-lite'); ?></span></a>
                  <?php 
                    wp_nav_menu( array( 
  ...
  <?php if(get_theme_mod('vw_tour_lite_loader_enable',true)==1){ ?>
    <div id="preloader">
      <div id="status">
        <?php $theme_lay = get_theme_mod( 'vw_tour_lite_loader_icon','Two Way');
