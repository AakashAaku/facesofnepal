...
$fontformats  = explode(",",'Roboto Slab,Arial,Georgia,Verdana,Tahoma');
...
$google_fonts  = explode(",",'Roboto+Slab');
$fontcount = count($google_fonts);
for($i=0;$i<$fontcount;$i++) {
$google_font[$i] = "//fonts.googleapis.com/css?family=".$google_fonts[$i];
} 
wp_localize_script('jquery-grideditor', 'google_font', $google_font);
...
<li role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab1" href="#tt_editor_tab1" role="tab" >' . __( 'Default Editor','TT-7theme--0066') . '</a></li>
<li class="active" role="presentation"><a data-toggle="tab" aria-controls="tt_editor_tab2" href="#tt_editor_tab2" role="tab">' . __( 'Custom Editor','TT-7theme--0066') . '</a></li>
</ul>';
