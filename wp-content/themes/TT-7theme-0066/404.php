...
<div>
<input type="image" height="<?php echo TemplateToaster_theme_option('ttr_error_image_height');?>px" width="<?php echo TemplateToaster_theme_option('ttr_error_image_width');?>px" alt="Error Image" src="<?php if(TemplateToaster_theme_option('ttr_error_image')): echo TemplateToaster_theme_option('ttr_error_image') ; else: echo get_template_directory_uri().'/images/gototop0.png'; endif; ?>"/>
</div>
<?php endif; ?>
<?php the_widget( 'WP_Widget_Recent_Posts', array( 'number' => 10 ), array( 'widget_id' => '404' ) ); ?>
<div class="widget">
<br/>
	<h2><?php _e( 'Most Used Categories', 'TT-7theme--0066' ); ?></h2>
<ul>
...
<?php
$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'TT-7theme--0066' ), convert_smilies( ':)' ) ) . '</p>';
