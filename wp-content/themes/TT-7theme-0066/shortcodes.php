...
function TemplateToaster_contact_form($atts)
{
    ob_start();
	 extract( shortcode_atts( array(
		...
		'btnclasses' => 'pull-left btn btn-default'
    ), $atts ) );
...
<div class="contactformdiv">
    <form method="post" class="form-horizontal" id="ContactForm0" style="<?php echo $styles;?>">
	  ...
	  <label class="col-sm-4 control-label <?php if(isset($value_contact[$key][$newkey.'req']) && $value_contact[$key][$newkey.'req'] == 'on'){ echo" required "; }  ?>">
      ...
      <div class="form-group">
        <label class="col-sm-4 control-label required">
          <?php echo(__('Email:',"TT-7theme--0066"));?>
        </label>
      ...
      <div class="form-group">
        <label class="col-sm-4 control-label">
          <?php echo(__('Message:',"TT-7theme--0066"));?>
        </label>
      ...
      <div class="form-group">
        <div class="col-sm-8 col-sm-offset-4">
          <input type="submit" value="<?php _e($btntitle , '','TT-7theme--0066');?>" name="submit_values" class="<?php echo $btnclasses;?>">
        </div>
      </div>
  ...
  if (!function_exists('TemplateToaster_contact_form_generate_response'))
{
    ...
    {     	
        ...
        $message .= __('Message:   ',"TT-7theme--0066").$_POST['message_text'].' '.$sender;
