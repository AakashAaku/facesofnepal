jQuery(document).ready(function () {
      ...
      success: function (content_options) {
        ...
        jQuery.each(content_options, function (content_option_id, content_option) {
          ...
          if (content_option_id != "Sidebars" && content_option.length > 0) {
            str = str + "<div class='col-md-6'><div style='padding: 0px 16px;'><div class='contenttitle'><span><input type='checkbox' id='" + content_option_id + "Options' class='optionscheckbox'>Select All</span><h4>" + content_option_id + "</h4></div><ul>";
          }
          jQuery.each(content_option, function (content_id, content) {
            if (content_option_id == 'Pages') {
              ...
              str = str + "<div class='col-md-6'><div style='padding: 0px 16px;'><div class='contenttitle'><span><input type='checkbox' id='" + content_id.split(" ").join("") + "Options' class='optionscheckbox'>Select All</span><h4>" + content_id + "</h4></div><ul>";
              jQuery.each(content, function (sidebar_content_id, sidebar_content) {
                if(content_id == 'Sidebar 1'){
              ...
              str = str + "</ul></div></div>";
            } else if (content_option_id == 'Footer') {
  ...
  jQuery(window).click(function (event) {
    ...
    if (jQuery(event.target).attr('id')) {
      ...
      else if (optionsid == 'PagesOptions') {
